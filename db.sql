...
-- Started on 2022-08-04 05:16:20
...
--
-- TOC entry 228 (class 1255 OID 52406)
-- Name: add_book(text, text, text, text, text, integer, integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.add_book(par_title text, par_author text, par_pubication text, par_isbn text, par_content text, par_price integer, par_piece integer, par_image_file text) OWNER TO postgres;

--
-- TOC entry 227 (class 1255 OID 44237)
-- Name: add_order(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.add_order(par_uid integer) OWNER TO postgres;
...
ALTER FUNCTION public.add_to_cart(par_uid integer, par_bid integer) OWNER TO postgres;

--
-- TOC entry 233 (class 1255 OID 52407)
-- Name: delete_book(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.delete_book(par_bid integer) OWNER TO postgres;

--
-- TOC entry 211 (class 1255 OID 44227)
-- Name: delete_cart_item(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.delete_cart_item(par_uid integer, par_cid integer) OWNER TO postgres;

--
-- TOC entry 236 (class 1255 OID 44216)
-- Name: get_book(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_book(par_id integer) OWNER TO postgres;
...
-- Name: get_cart(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_cart(par_uid integer) OWNER TO postgres;

--
-- TOC entry 234 (class 1255 OID 44241)
-- Name: get_detail(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_detail(par_user_id integer, par_order_id integer) OWNER TO postgres;
...
ALTER FUNCTION public.get_orders(par_user_id integer) OWNER TO postgres;
...
ALTER FUNCTION public.get_user(par_id integer) OWNER TO postgres;

--
-- TOC entry 212 (class 1255 OID 52405)
-- Name: get_user_pass(text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.get_user_pass(par_email text) OWNER TO postgres;
...
-- Name: update_book(integer, text, text, text, text, text, integer, integer, text); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_book(par_id integer, par_title text, par_author text, par_pubication text, par_isbn text, par_content text, par_price integer, par_piece integer, par_image_file text) OWNER TO postgres;

--
-- TOC entry 230 (class 1255 OID 52404)
-- Name: update_user(integer, text, text, text, text, text, integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.update_user(par_id integer, par_username text, par_email text, par_imfile text, par_address text, par_state text, par_pcode integer) OWNER TO postgres;

--
-- TOC entry 232 (class 1255 OID 44228)
-- Name: verify_address(integer); Type: FUNCTION; Schema: public; Owner: postgres
--
...
ALTER FUNCTION public.verify_address(par_id integer) OWNER TO postgres;
...
--
-- TOC entry 3047 (class 0 OID 44126)
-- Dependencies: 200
-- Data for Name: book; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.book (id, title, author, publication, isbn, content, price, piece, image_file) FROM stdin;
1	A Harry Potter and the Philosophers Stone	J.K. Rowling	Bloomsbury Publishing	12345678915	Escape to Hogwarts with the unmissable series that has sparked a lifelong reading journey for children and families all over the world. The magic starts here.	329	-4	ce3fdfb1ab04a4cf.jpg
\.
...
COPY public.cart (id, user_id, book_id) FROM stdin;
\.
...
COPY public."order" (id, user_id, amount, order_date) FROM stdin;
\.
...
COPY public.order_book (id, user_id, book_id, order_id) FROM stdin;
\.
...
COPY public."user" (id, username, email, image_file, password, address, state, pincode, role) FROM stdin;
6	testadmin	test@admin.com	image	$2b$12$W6dD.2rp8M2hM7I.xDTQ3.DVQx6lqsqlKBur6zHxK8/g.6hh8ymJi	\N	\N	\N	admin
5	test	test@test.com	default.jpg	$2b$12$W6dD.2rp8M2hM7I.xDTQ3.DVQx6lqsqlKBur6zHxK8/g.6hh8ymJi	Block 4, Lot 9\nPhase 2, Villa Trinitas Subdivision, Bugo	Mis. Or.	9000	user
\.
...
SELECT pg_catalog.setval('public.order_book_id_seq', 10, true);
...
-- Completed on 2022-08-04 05:16:20
